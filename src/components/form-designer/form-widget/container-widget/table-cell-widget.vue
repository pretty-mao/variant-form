      ...
      >
        ...
        <el-dropdown-menu slot="dropdown">
          ...
          <el-dropdown-item
            ...
            divided
            >{{ i18nt("designer.setting.mergeLeftColumn") }}</el-dropdown-item
          >
          <el-dropdown-item
            command="mergeRightCol"
            :disabled="mergeRightColDisabled"
            >{{ i18nt("designer.setting.mergeRightColumn") }}</el-dropdown-item
          >
          <el-dropdown-item
            command="mergeWholeRow"
            :disabled="mergeWholeRowDisabled"
            >{{ i18nt("designer.setting.mergeEntireRow") }}</el-dropdown-item
          >
          <el-dropdown-item
            command="mergeAboveRow"
            :disabled="mergeAboveRowDisabled"
            divided
            >{{ i18nt("designer.setting.mergeRowAbove") }}</el-dropdown-item
          >
          <el-dropdown-item
            command="mergeBelowRow"
            :disabled="mergeBelowRowDisabled"
            >{{ i18nt("designer.setting.mergeRowBelow") }}</el-dropdown-item
          >
          <el-dropdown-item
            command="mergeWholeCol"
            :disabled="mergeWholeColDisabled"
            >{{ i18nt("designer.setting.mergeEntireColumn") }}</el-dropdown-item
          >
          <el-dropdown-item
            command="undoMergeRow"
            :disabled="undoMergeRowDisabled"
            divided
            >{{ i18nt("designer.setting.undoMergeRow") }}</el-dropdown-item
          >
          <el-dropdown-item
            command="undoMergeCol"
            :disabled="undoMergeColDisabled"
            >{{ i18nt("designer.setting.undoMergeCol") }}</el-dropdown-item
          >
          <el-dropdown-item
            command="deleteWholeCol"
            :disabled="deleteWholeColDisabled"
            divided
            >{{ i18nt("designer.setting.deleteEntireCol") }}</el-dropdown-item
          >
          <el-dropdown-item
            command="deleteWholeRow"
            :disabled="deleteWholeRowDisabled"
            >{{ i18nt("designer.setting.deleteEntireRow") }}</el-dropdown-item
          >
        </el-dropdown-menu>
      </el-dropdown>
    </div>
...
export default {
  ...
  computed: {
    ...
    mergeLeftColDisabled() {
      return (
        this.colIndex <= 0 ||
        this.colArray[this.colIndex - 1].options.rowspan !==
    ...
    mergeRightColDisabled() {
      ...
      return (
        ...
        this.colArray[rightColIndex].options.rowspan !==
          this.widget.options.rowspan
      );
    },
    ...
    mergeWholeRowDisabled() {
      return (
        this.colLength <= 1 || this.colLength === this.widget.options.colspan
      );
    },
    ...
    mergeWholeColDisabled() {
      return (
        this.rowLength <= 1 || this.rowLength === this.widget.options.rowspan
      );
    },
    ...
    deleteWholeColDisabled() {
      ...
      return (
        this.colLength === 1 || this.widget.options.colspan === this.colLength
      );
    },

    deleteWholeRowDisabled() {
      return (
        this.rowLength === 1 || this.widget.options.rowspan === this.rowLength
      );
    },
  },
  watch: {
