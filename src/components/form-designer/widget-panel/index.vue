    ...
    <div class="panel-container">
      ...
      <el-collapse v-model="activeNames" class="widget-collapse">
        <el-collapse-item name="1" :title="i18nt('designer.containerTitle')">
          <!-- draggable  list和value一样  colne是否克隆列表项 options配置项 
            tag默认div，解析内部标签  filter不能拖动筛选类名  start拖拽开始事件，可以做监听加拖拽样式拖拽提示等
              end拖拽结束事件，可以隐藏退拽提示等-->
          <draggable
            tag="ul"
            :list="containers"
